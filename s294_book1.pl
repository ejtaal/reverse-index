# Open Uni SK293 Book 1 pdf:
column_left => [ [ 0, 124, 388, 653 ], [ 0, 61, 326, 590 ]],
avg_indent => 18.0,
comma_index => 0,
space_index => 1,
...
marked_lines => [ 'height="14" font="5">', '<b>' ],
bad_lines => [ 'font="23"','font="3">' ],
#column_reset_lines => ['self-MHC restricted activity 169'],
#marked_lines => qw{
#	'height="13"'
#	'height="16"'
#	},
